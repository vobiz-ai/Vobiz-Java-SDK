...
public class AsyncRawCallsClient {
   ...
   */
  public CompletableFuture<VobizApiHttpResponse<MakeCallResponse>> makeCall(String authId,
   ...
   */
  public CompletableFuture<VobizApiHttpResponse<MakeCallResponse>> makeCall(String authId,
      MakeCallRequest request, RequestOptions requestOptions) {
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      CompletableFuture<VobizApiHttpResponse<MakeCallResponse>> future = new CompletableFuture<>();
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new VobizApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, MakeCallResponse.class), response));
              return;
            }
