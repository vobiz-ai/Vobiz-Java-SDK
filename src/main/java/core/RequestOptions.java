...
public final class RequestOptions {
  ...
  private RequestOptions(String apiKey, String authToken, Optional<Integer> timeout,
  ...
  public Map<String, String> getHeaders() {
    ...
    if (this.apiKey != null) {
      headers.put("X-Auth-ID", this.apiKey);
    }
  ...
  public static class Builder {
    ...
    public RequestOptions build() {
      return new RequestOptions(apiKey, authToken, timeout, timeoutTimeUnit, headers, headerSuppliers, queryParameters, queryParameterSuppliers);
    }
  }
}
